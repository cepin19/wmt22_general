...
while true
do
for corp in czeng20-train.filt.filtered.gt0.02 czeng20-enmono.filt.filtered.gt0.02
do
src=$corp.en.fs2
tgt=$corp.cs.fs2
...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.base.fs2.block_40k.no_csmono.npz   --type transformer --task transformer-base \
