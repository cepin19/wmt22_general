...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.deeper.run2.fs2.block_40k.npz   --type transformer --task transformer-big \
    ...
    --tied-embeddings-all  \
    --learn-rate 0.0002 --lr-warmup 16000 --lr-decay-inv-sqrt 16000 \
