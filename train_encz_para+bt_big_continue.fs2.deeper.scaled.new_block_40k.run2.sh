...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.big_continued_adqd.split2.deeper.fs2.new_block_40k.run2.npz   --type transformer \
    ...
    --log data/train_encz.deeper.new_block_40k.run2.log --valid-log data/valid.log \
