...
updates=$((i*80000))
$marian/marian \
    --model model/model_transformer_encz.base.fs2.block_80k.2.npz   --type transformer --task transformer-base \
    ...
    --log data/train_encz.block_80k.base.log --valid-log data/valid.log \
    --tied-embeddings-all  \
