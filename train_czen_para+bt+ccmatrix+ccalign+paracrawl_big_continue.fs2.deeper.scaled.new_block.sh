...
updates=$((i*50000))
$marian/marian \
    --model model/model_transformer_czen+bt+ccmatrix+ccalign+paracrawl.big_continued_adqd.split2.deeper.fs2.new_block.npz   --type transformer \
    ...
    --log data/train_czen+bt+ccmatrix+ccalign+paracrawl.log --valid-log data/valid.log \
