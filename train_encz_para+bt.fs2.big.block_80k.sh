...
updates=$((i*80000))
$marian/marian \
    --model model/model_transformer_encz.big.fs2.block_80k.npz   --type transformer --task transformer-big \
    ...
    --log data/train_encz.block_80k.big.log --valid-log data/valid.log \
    --tied-embeddings-all  \
