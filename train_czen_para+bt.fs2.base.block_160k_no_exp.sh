...
updates=$((i*160000))
$marian/marian \
    --model model/model_transformer_czen.base.fs2.block_160k.noexp.npz   --type transformer --task transformer-base \
    ...
    --log data/train_encz.block_40k.base.noexp.log --valid-log data/valid.log \
    --tied-embeddings-all  \
