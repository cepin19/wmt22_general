...
src=czeng20-train+enmono.filt.filtered.gt0.02.en.fs2
tgt=czeng20-train+enmono.filt.filtered.gt0.02.cs.fs2
scores=czeng20-train+enmono.filt.filtered.gt0.02.adq_scores
$marian/marian \
    --model model/model_transformer_encz.base.fs2.mixed_corp.nocsmono.npz   --type transformer --task transformer-base \
