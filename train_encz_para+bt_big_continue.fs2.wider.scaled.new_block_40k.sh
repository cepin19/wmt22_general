...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.big_continued_adqd.split2.wider2.fs2.new_block_40k.npz   --type transformer \
    ...
    --log data/train_encz.wider.new_block_40k.log --valid-log data/valid.log \
    --enc-depth 6 --transformer-depth-scaling --dec-depth 4 \
    --transformer-preprocess n --transformer-postprocess da \
	--tied-embeddings-all --dim-emb 3072 --transformer-dim-ffn 8192 \
    ...
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 1 \
