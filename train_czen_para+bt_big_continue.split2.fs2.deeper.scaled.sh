...
$marian/marian \
    --model model/model_transformer_czen.big_continued_adq_scored.split2.deeper.fs2.run2.npz   --type transformer \
    --train-sets  corp/czeng20-train.sentence.head25M.cs.fs2 corp/czeng20-train.sentence.head25M.en.fs2  \
    --max-length 150 \
    ...
    --log data/train_czen2.deeper.log --valid-log data/valid.log \
    ...
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 16000 --lr-report  --data-weighting corp/czeng20-train.sentence.head25M.adq_score \
...
$marian/marian \
    ...
    --tied-embeddings-all --dim-emb 1024 --transformer-dim-ffn 4096 \
    --transformer-dropout 0.05 --transformer-dropout-attention 0.05 --transformer-dropout-ffn 0.05 --label-smoothing 0.1 \
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 16000 --lr-report  --data-weighting corp/czeng20-csmono.head25M.filt.adq_score \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev --sync-sgd --seed 1234 --optimizer-delay 1 \
...
$marian/marian \
    ...
    --tied-embeddings-all --dim-emb 1024 --transformer-dim-ffn 4096 \
    --transformer-dropout 0.05 --transformer-dropout-attention 0.05 --transformer-dropout-ffn 0.05 --label-smoothing 0.1 \
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 16000 --lr-report  --data-weighting corp/czeng20-train.tail+25M.filt.adq_score \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev  --sync-sgd --seed 1234 --optimizer-delay 1 \
...
$marian/marian \
    ...
    --tied-embeddings-all --dim-emb 1024 --transformer-dim-ffn 4096 \
    --transformer-dropout 0.05 --transformer-dropout-attention 0.05 --transformer-dropout-ffn 0.05 --label-smoothing 0.1 \
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 16000 --lr-report  --data-weighting corp/czeng20-enmono.tail+20M.filt.adq_score   \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev  --sync-sgd --seed 1234 --optimizer-delay 1 \
...
$marian/marian \
    ...
    --tied-embeddings-all --dim-emb 1024 --transformer-dim-ffn 4096 \
    --transformer-dropout 0.05 --transformer-dropout-attention 0.05 --transformer-dropout-ffn 0.05 --label-smoothing 0.1 \
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 16000 --lr-report  --data-weighting corp/czeng20-csmono.tail+25M.filt.adq_score \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev  --sync-sgd --seed 1234 --optimizer-delay 1 \
...
$marian/marian \
    ...
    --tied-embeddings-all --dim-emb 1024 --transformer-dim-ffn 4096 \
    --transformer-dropout 0.05 --transformer-dropout-attention 0.05 --transformer-dropout-ffn 0.05 --label-smoothing 0.1 \
    --learn-rate 0.0001 --lr-warmup 32000 --lr-decay-inv-sqrt 32000 --lr-report  --data-weighting corp/czeng20-enmono.head20M.filt.adq_score \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev  --sync-sgd --seed 1234 --optimizer-delay 1 \
