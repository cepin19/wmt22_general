...
updates=$((i*50000))
$marian/marian \
    --model model/model_transformer_encz.big_continued_adqd.split2.deeper.fs2.new_block.npz   --type transformer \
    ...
    --log data/train_encz.deeper.new_block.log --valid-log data/valid.log \
