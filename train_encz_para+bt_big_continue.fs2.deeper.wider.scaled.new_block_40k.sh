...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.big_continued_adqd.split2.wider.fs2.new_block_40k.npz   --type transformer \
    ...
    --tied-embeddings-all --dim-emb 4096 --transformer-dim-ffn 6144 \
    ...
    --devices $dev --sync-sgd --seed 1234 --optimizer-delay 8 \
