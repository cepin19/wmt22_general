...
while true
do
for corp in czeng20-train.filt.filtered.gt0.02 czeng20-csmono.filt.filtered.gt0.02 
do
src=$corp.cs.fs2
tgt=$corp.en.fs2
...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_czen.base.fs2.block_40k.no_enmono.npz   --type transformer --task transformer-base \
    ...
    --log data/train_encz.block_40k.base.no_enmono.log --valid-log data/valid.log \
    --tied-embeddings-all  \
