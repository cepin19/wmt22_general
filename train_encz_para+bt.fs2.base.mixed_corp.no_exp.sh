...
src=czeng20-train+csmono+enmono.filt.filtered.gt0.02.en.fs2
tgt=czeng20-train+csmono+enmono.filt.filtered.gt0.02.cs.fs2
scores=czeng20-train+csmono+enmono.filt.filtered.gt0.02.adq_scores
$marian/marian \
    --model model/model_transformer_encz_adq.base.fs2.mixed_corp.noexp.npz   --type transformer --task transformer-base \
    ...
    --log data/train_encz.mixed_corp.base.noexp.log --valid-log data/valid.log \
    --tied-embeddings-all  \
    --lr-report  --data-weighting corp/$scores \
    --optimizer-params 0.9 0.98 1e-09 --clip-norm 5 \
    --devices $dev --sync-sgd --seed 1234 --optimizer-delay 1 \
    --exponential-smoothing 0 --sqlite -T $tmp --no-restore-corpus 
