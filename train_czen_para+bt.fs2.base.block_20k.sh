...
updates=$((i*20000))
$marian/marian \
    --model model/model_transformer_czen.base.fs2.block_20k.npz   --type transformer --task transformer-base \
    ...
    --log data/train_encz.block_20k.base.log --valid-log data/valid.log \
    --tied-embeddings-all  \
