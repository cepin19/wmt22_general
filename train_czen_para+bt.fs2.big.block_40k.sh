...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_czen.big.fs2.guided.block_40k.npz    --type transformer --task transformer-big \
    ...
    --log data/train_czen.big.block_40k.guided.log --valid-log data/valid.log \
    --tied-embeddings-all  \
    --lr-report  \
