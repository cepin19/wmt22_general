...
$marian/marian \
    --model model/model_transformer_encz_adq.big.fs2.mixed_corp.noexp.npz   --type transformer --task transformer-big \
    ...
    --log data/train_encz.mixed_corp.big.noexp.log --valid-log data/valid.log \
    --tied-embeddings-all  \
