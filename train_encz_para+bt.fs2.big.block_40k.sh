...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.big.fs2.block_40k.npz   --type transformer --task transformer-big \
    ...
    --log data/train_encz.block_40k.big.log --valid-log data/valid.log \
    --tied-embeddings-all  \
