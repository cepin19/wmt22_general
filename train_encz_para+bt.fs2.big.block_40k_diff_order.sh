...
while true
do
for corp in czeng20-train.filt.filtered.gt0.02 czeng20-csmono.filt.filtered.gt0.02 czeng20-enmono.filt.filtered.gt0.02
do
src=$corp.en.fs2
tgt=$corp.cs.fs2
...
updates=$((i*40000))
$marian/marian \
    --model model/model_transformer_encz.big.fs2.block_40k_diff_order.npz   --type transformer --task transformer-big \
    ...
    --log data/train_encz.block_40k.big_diff_order.log --valid-log data/valid.log \
    --tied-embeddings-all  \
