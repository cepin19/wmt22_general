...
$marian/marian \
    --model model/model_transformer_encz_adq.big.fs2.mixed_corp.npz   --type transformer --task transformer-big \
    ...
    --log data/train_encz.mixed_corp.big.log --valid-log data/valid.log \
    --tied-embeddings-all  \
